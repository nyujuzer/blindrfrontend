...
const RegSite = (prop: navProps) => {
  ...
  function handleStylehange(value: string, caller: Groups) {
    var type =
      caller === Groups.GENDER ? formData.gender : formData.preferences;
  ...
  function handleDateChange(date: Date) {
    setFormData((prev) => ({ ...prev, age: date.toString() }));
      ...
      >
        <Card style={[RegisterStyles.card]}>
          ...
          <Card.Content>
            ...
            <PasswordField
              onChangeText={(text: string) => {
                setFormData((prev) => ({ ...prev, conf: text }));
              }}
            ></PasswordField>
          </Card.Content>
        </Card>
        <Card style={[RegisterStyles.card]}>
          <Card.Title
            titleStyle={{ color: "white" }}
            title="And i'd like to ask for your birthday as well"
          />
          <View style={RegisterStyles.center}>
            {formData.age?<Text style={{color:"white"}}>{formData.age.toString()}</Text>:null}
            <StyledButton
          ...
          <AppropriateDatePicker
            ...
            style={{
              container: RegisterStyles.modalContainer,
              modalView: RegisterStyles.modalView,
            }}
            onChange={(text: any) => {
        ...
        <Card style={RegisterStyles.card}>
          <Card.Title
            titleStyle={{ color: "white" }}
            title="And i also need what you're into..."
          />
          <RadioButton.Group
          ...
          >
            <View style={{ flex: 3, flexDirection: "row" }}>
              ...
              <RadioButton.Item
                ...
                value="female"
                status={
                  formData.preferences === "female" ? "checked" : "unchecked"
                }
                label="female"
              />
              <RadioButton.Item
